App = {
    ...
    uploadImageIPFS: async function (event) {
        ...
        $("#img").attr("src",`https://ipfs.infura.io/ipfs/${added.path}`);
        $("#path").text(`Path image: ${added.path}`);
    }
};
